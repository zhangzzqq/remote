...
import com.mdsd.telemedicine.BuildConfig;
import com.mdsd.telemedicine.base.BaseApplication;
import com.mdsd.telemedicine.utils.NetWorkUtils;
...
public class ApiStrategy {
    ...
    private ApiStrategy() {
        ...
        //缓存
        Cache cache=null;
        if(BaseApplication.getContext().getCacheDir()!=null){
...
//        if (cacheDir != null) {
//            File mCacheDir = new File(cacheDir,"cache");
